      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-muted-foreground mb-5 leading-relaxed font-light">
            We started as a small crew building paver patios and retaining walls in San Jose neighborhoods. Over the years, our scope expanded naturally because homeowners kept asking us to do more — outdoor kitchens, pergolas, complete backyard transformations, driveway replacements. We grew by doing good work and earning referrals, not by running ads promising the lowest price. Today, we serve homeowners across the Bay Area — from $1.5 million homes in San Jose to multi-million-dollar estates in Atherton, Hillsborough, Los Gatos, and Saratoga.
          </p>
          <p className="text-muted-foreground mb-5 leading-relaxed font-light">
