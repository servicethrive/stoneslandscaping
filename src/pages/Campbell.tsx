    ...
    <Layout>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-muted-foreground mb-5 leading-relaxed font-light">
            Campbell's flat terrain and typical lot sizes make most projects straightforward to plan and execute, which often translates to efficient timelines and competitive project costs compared to hillside communities. That said, we bring the same level of craftsmanship and attention to detail to every Campbell project that we deliver on the largest estate projects in the Bay Area — the same base preparation, the same premium materials, the same {BUSINESS.paverWarrantyYears}-year warranty. Quality doesn't scale with property value; it's our standard.
          </p>
